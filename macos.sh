...
sudo scutil --set ComputerName "EA-MacBook-pro"
sudo scutil --set HostName "EA-MacBook-pro"
sudo scutil --set LocalHostName "EA-MacBook-pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "EA-MacBook-pro"
...
# Tweak the auto-hiding Dock delay
